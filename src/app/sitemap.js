...
export default async function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${SITE_URL}/health`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${SITE_URL}/drug-interactions`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
